...
const style = {
    ...
    playButton: `bg-green-500 w-12 h-12 flex pl-2 items-center justify-center rounded-full cursor-pointer hover:bg-opacity-75`,
  }
      ...
      <div className={style.playlistTextContent}>
        ...
        <div className='ml-5'>
          ...
          <div className='flex items-center mt-5'>
            ...
            <p>
              <span className='text-bold'>StreamBeats</span> • 2020 • 46 songs, 3
              hr 20 min
            </p>
          </div>
        </div>
